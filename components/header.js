    ...
    <>
      ...
      >
          ...
          <Link href="/profile">
            <a className="header-link">
              <div className="header-container1">
                ...
                <span className="header-text TextSM">Meu perfil</span>
              </div>
            </a>
          </Link>
        ...
        <div className="header-container3">
          <svg viewBox="0 0 877.7142857142857 1024" className="header-icon09">
          ...
          <svg viewBox="0 0 877.7142857142857 1024" className="header-icon13">
