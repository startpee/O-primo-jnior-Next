      ...
      <div className="home-container">
        ...
        <div className="home-section2">
          <div className="home-container03">
            ...
            <h2 className="home-text01 Text2XL">
          ...
          <div className="home-growing-company-section">
            ...
            <div className="home-container04">
              ...
              <h3 className="home-text04 Healine">Minha empresa</h3>
        ...
        <div className="home-section3">
          <div className="home-container08">
            <h6 className="home-text07 TextSM">
              <span>ON THE COASTLINE</span>
            </h6>
            <h3 className="home-text09 Healine">We are missing the summer</h3>
            ...
            <div className="home-services">
              ...
              <div className="home-container09">
                ...
                <h1 className="home-text12 TextXL">Grow your market</h1>
              ...
              <div className="home-container11">
                ...
                <h1 className="home-text14 TextXL">Launch time</h1>
            ...
            <div className="home-contact">
              ...
              <h2 className="home-text16">Type in the bellow form</h2>
              <span className="home-text17 TextXL">
              ...
              <div className="home-form">
                <h1 className="home-text18">Want to work with us?</h1>
                <span className="home-text19 TextXL">
                  Complete this form and we will get back to you in 24 hours.
                </span>
                <span className="home-text20 TextXS">FULL NAME</span>
                <input
                  type="text"
                  placeholder="Full Name"
                  className="home-textinput TextSM input"
                />
                <span className="home-text21 TextXS">EMAIL</span>
                <input
                  type="text"
                  placeholder="Email"
                  className="home-textinput1 TextSM input"
                />
                <span className="home-text22 TextXS">MESSAGE</span>
                <textarea
                  cols="80"
                  rows="4"
                  disabled="true"
      ...
      <style jsx>
        {`
          ...
          .home-container01 {
            ...
            background-image: url('/playground_assets/pexels-caio-45917%20%5B2%5D%20%5B5%5D-1500h.webp');
          }
          .home-container02 {
            height: 749px;
            display: flex;
